...
<link rel="stylesheet" href="${pageContext.request.contextPath}/classList/daejeonClass.css">
</head>
         ...
         <c:if test="${count != 0}">
            ...
            <div class="pageNum">
            	<c:forEach var = "i" begin="${startPage}" end ="${endPage}">
            		<a href="${pageContext.request.contextPath}/daejeonClass.do?pageNum=${i}">[${i}]</a>
            	</c:forEach>
            </div>
