...
<link rel="stylesheet" href="${pageContext.request.contextPath}/classList/cookingClass.css">
</head>
...
<div class="pic"></div>
    <div class="my_wrap">
        <div class="side_menu">
           ...
           <div class="current_menu">요리클래스</div>
           <div class="line"></div>
            ...
            <hr>
             <div class="side_detail">
               <a href="${pageContext.request.contextPath}/cookingClass.do"class="current_menu2"><div>요리클래스</div>
                <div class="side_detail2">></div>
                </a>
            </div>
            <hr>
         ...
         <c:if test="${count != 0}">
            ...
            <div class="pageNum">
            	<c:forEach var = "i" begin="${startPage}" end ="${endPage}">
            		<a href="${pageContext.request.contextPath}/cookingClass.do?pageNum=${i}">[${i}]</a>
            	</c:forEach>
            </div>
