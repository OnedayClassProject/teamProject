...
<link rel="stylesheet" href="${pageContext.request.contextPath}/classList/soapClass.css">
</head>
    ...
    <div class="my_wrap">
        <div class="side_menu">
           ...
           <div class="line"></div> 
            ...
            <hr>
             <div class="side_detail">
               <a href="${pageContext.request.contextPath}/soapClass.do"class="current_menu2"><div>비누클래스</div>
                <div class="side_detail2">></div>
                </a>
            </div>
            <hr>
