        ...
        <div class="side_menu">
         ...
         <c:if test="${count != 0}">
            ...
            <c:forEach var="classBean" items="${list}">
                 ...
                 <div class="class-name">
					...
					<div class="like_image"> 
	                	<img class="like" src="${pageContext.request.contextPath}/images/KakaoTalk_Photo_2020-09-14-14-19-16.png">
			...
			<c:set var="j" value="${j+1}"/>
                        ...
                        <div class="pageNum">
            	<c:if test="${pageNum > 1}">
            		<div class="pageNum3" onclick="location.href='${pageContext.request.contextPath}/soapClass.do?pageNum=${1}'"> << </div>
            	</c:if>
            	<c:if test="${pageNum > startPage}">
            		<div class="pageNum2" onclick="location.href='${pageContext.request.contextPath}/soapClass.do?pageNum=${pageNum-1}'"> < </div>
            	</c:if>
            	<c:forEach var = "i" begin="${startPage}" end ="${endPage}">
            		<div class="pageNum2" onclick="location.href='${pageContext.request.contextPath}/soapClass.do?pageNum=${i}'">${i}</div>
            	</c:forEach>
            	<c:if test="${pageNum < pageCount}">
            		<div class="pageNum2" onclick="location.href='${pageContext.request.contextPath}/soapClass.do?pageNum=${pageNum+1}'"> > </div>
            	</c:if>
            	<c:if test="${pageNum < pageCount}">
            		<div class="pageNum3" onclick="location.href='${pageContext.request.contextPath}/soapClass.do?pageNum=${pageCount}'"> >> </div>
            	</c:if>
            </div>
...
$(".like").on("click",function(){
	...
	var likeOn = "${pageContext.request.contextPath}/images/KakaoTalk_Photo_2020-09-14-14-19-23.png";
	var likeOff = "${pageContext.request.contextPath}/images/KakaoTalk_Photo_2020-09-14-14-19-16.png"
	console.log(num);
...
function like(){
	$.ajax({
		...
		console.log("data" + data);
			if(data == 1){
				cla.children(".like").attr("src","${pageContext.request.contextPath}/images/KakaoTalk_Photo_2020-09-14-14-19-23.png")
