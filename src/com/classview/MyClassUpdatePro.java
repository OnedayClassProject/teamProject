...
public class MyClassUpdatePro  implements CommandHandler {
	...
	public String process(HttpServletRequest request, HttpServletResponse response)
		    ...
		    int class_registrynum = Integer.parseInt(multipartRequest.getParameter("class_registrynum"));
		    ...
		    int result = cdao.classInfoUpdate(cb,class_registrynum); 
